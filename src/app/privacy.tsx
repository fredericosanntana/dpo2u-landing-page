  ...
  return (
    <div className="min-h-screen bg-white dark:bg-brand-chrome-900">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-32 max-w-3xl">
        ...
        <h2 className="text-xl font-semibold text-brand-chrome-900 dark:text-white mt-8 mb-3">Data Controller</h2>
        ...
        <h2 className="text-xl font-semibold text-brand-chrome-900 dark:text-white mt-8 mb-3">Purposes</h2>
        <ul className="list-disc pl-6 text-brand-platinum-800 dark:text-brand-platinum-400 space-y-2">
        ...
        <h2 className="text-xl font-semibold text-brand-chrome-900 dark:text-white mt-8 mb-3">Data Subject Rights</h2>
        <p className="text-brand-platinum-800 dark:text-brand-platinum-400">
        ...
        <h2 className="text-xl font-semibold text-brand-chrome-900 dark:text-white mt-8 mb-3">Cookies &amp; Consent</h2>
        <p className="text-brand-platinum-800 dark:text-brand-platinum-400">
        ...
        <h2 className="text-xl font-semibold text-brand-chrome-900 dark:text-white mt-8 mb-3">Data Security</h2>
        <p className="text-brand-platinum-800 dark:text-brand-platinum-400">
