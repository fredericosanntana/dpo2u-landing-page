...
export default function Step1CompanyInfo({ data, onChange }: Step1Props) {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-2xl font-serif font-bold mb-2 text-brand-gray-900 dark:text-white">Informações da Empresa</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2 md:col-span-2">
                    <label className="text-sm font-medium text-brand-gray-900 dark:text-white">Razão Social *</label>
                    <input
                        type="text"
                        value={data.nome}
                ...
                <div className="space-y-2">
                    <label className="text-sm font-medium text-brand-gray-900 dark:text-white">CNPJ *</label>
                    <input
                        type="text"
                        value={data.cnpj}
                ...
                {/* Setor */}
                <div className="space-y-2">
                    <label className="text-sm font-medium text-brand-gray-900 dark:text-white">Setor de Atuação *</label>
                    <select
                        value={data.setor}
                ...
                {/* Colaboradores */}
                <div className="space-y-2">
                    <label className="text-sm font-medium text-brand-gray-900 dark:text-white">Número de Colaboradores *</label>
                    <select
                ...
                <div className="space-y-2 md:col-span-2 pt-4 border-t border-border">
                    <h3 className="font-semibold text-lg mb-4 text-brand-gray-900 dark:text-white">Dados do DPO / Responsável</h3>
                </div>

                <div className="space-y-2">
                    <label className="text-sm font-medium text-brand-gray-900 dark:text-white">Nome do Responsável *</label>
                    <input
                        type="text"
                ...
                <div className="space-y-2">
                    <label className="text-sm font-medium text-brand-gray-900 dark:text-white">Email de Contato *</label>
                    <input
                        type="email"
                        value={data.email}
                ...
                <div className="space-y-2">
                    <label className="text-sm font-medium text-brand-gray-900 dark:text-white">Telefone (Opcional)</label>
                    <input
                        type="tel"
                        value={data.telefone || ''}
